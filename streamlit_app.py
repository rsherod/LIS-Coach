...
with funding_container:
    st.markdown("<div style='text-align: center; margin-top: 20px;'><small style='color: rgb(128, 128, 128);'>This bot was programmed with information from ci3t.org.</small></div>", unsafe_allow_html=True)
